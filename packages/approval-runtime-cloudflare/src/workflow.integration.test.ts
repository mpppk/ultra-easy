...
describe("ActionWorkflow / Cloudflare Workflows integration", () => {
  ...
  it("instance pause/resume後もDecision待機から再開できる", async () => {
    ...
    const waitingIntrospector = await introspectWorkflowInstance(env.ACTION_WORKFLOW, id);
